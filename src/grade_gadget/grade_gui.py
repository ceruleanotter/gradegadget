...
import os
import datetime
from xlrd import open_workbook,empty_cell, biffh
...
class GradeGadgetFrame(wx.Frame):
    ...
    def onGenerate(self, event):
        ...
        if not( os.access(self.text_ctrl_export.GetValue(), os.F_OK)):
            problemChildren.append(self.text_ctrl_export)    
        ...
        if checkterm == "":
            problemChildren.append(self.combo_term)
        else:
        ...
        if group == "":
            problemChildren.append(self.combo_group)      
        ...
        if not( os.access(self.text_ctrl_output.GetValue(), os.F_OK)):
            problemChildren.append(self.text_ctrl_output)
